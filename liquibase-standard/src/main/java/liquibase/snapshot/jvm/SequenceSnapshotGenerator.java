...
public class SequenceSnapshotGenerator extends JdbcSnapshotGenerator {
    ...
    protected void addTo(DatabaseObject<?> foundObject, DatabaseSnapshot snapshot) throws DatabaseException, InvalidExampleException {
        ...
        List<Map<String, Object>> sequences = Scope.getCurrentScope().getSingleton(ExecutorService.class).getExecutor("jdbc", database).queryForList(getSelectSequenceStatement(schema, database));
        if (sequences != null) {
